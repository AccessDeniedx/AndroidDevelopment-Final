...
public class DownloadTask extends AsyncTask<String ,Integer,Integer> {
    ...
    protected Integer doInBackground(String... params) {
        ...
        try {
            ...
            file = new File(directory + fileName);// 文件下载到的位置
            if (file.exists()) {
                downloadedLength = file.length();
                // 如果已存在，读取已下载的字节数，用于启动断点下载功能
            }
            ...
            if (response != null) {
                ...
                byte[] b = new byte[1024];int total = 0;int len;
    ...
    protected void onPostExecute(Integer status) {
        switch (status) {
            ...
            case TYPE_PAUSED: listener.onPaused();break;
